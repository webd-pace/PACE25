...
function isRequired(fieldName) {
  return REQUIRED_FIELDS[fieldName] ?? false; // default true if not listed
}
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.screenShot) {
        ...
        // If screenshot is required but absent, throw an error to stop submission
        if (isRequired("screenShot")) {
        ...
        >
          ...
          <div className="mb-10 pb-6">
            ...
            <p className="text-gray-600 text-center italic mb-2">
              ...
              – "One who is knowledgeable in policy and conduct."
            </p>
            <p className="text-gray-700 text-center max-w-2xl mx-auto leading-relaxed">
              A high-stakes, intellectually stimulating event designed to
              challenge participants’ understanding of{" "}
              <span className="font-semibold text-indigo-700">
                global politics, diplomacy, and policy-making
              </span>
              . Participants will craft, defend, and present legislative bills,
              as well as propose innovative solutions to pressing global issues.
            </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-700">
                    ...
                    – A group presentation to collaborate & discuss complex
                    topics.
                  </p>
                </div>
                <div className="flex items-start gap-4">
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl shadow-md p-6 mt-8 text-left border border-indigo-200">
              <h3 className="text-xl text- font-semibold text-indigo-700 mb-4">
                Event Details
              </h3>
              <p className="text-gray-700">
                <strong>Date:</strong> September 28, 2025
              </p>
              <p className="text-gray-700">
                <strong>Time:</strong> 9 am - 5 pm
              </p>
              <p className="text-gray-700">
                <strong>Venue:</strong> Walchand College Of Engineering, Sangli
              </p>
              <p className="text-gray-700">
                <strong>Contact:</strong> Shardul – +91 8080884368
              </p>
            </div>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            />
            <InputField
              label="Participant's Contact Number (Preferably WhatsApp)"
              name="phone"
              type="tel"
            ...
            />
            <InputField
              label="Participant's College Or Institute"
              name="college"
              type="text"
            ...
            <SelectField
              ...
              options={[
                "Offline Mode (in WCE)",
                "Online Mode (At your preferable location)",
              ]}
            />
            ...
            {formData.eventmode && (
              <div className="text-center my-6 p-6 bg-gray-50 rounded-xl shadow-md">
                ...
                <p className="mt-3 text-sm text-gray-600">
                  UPI ID:{" "}
                  <span className="font-medium">chinmyibargale@oksbi</span>
                </p>
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                required={isRequired("transactionID")}
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="relative flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-400 transition">
                ...
                <input
                  ...
                  required={isRequired("screenShot")}
                />
                {screenshotName ? (
...
function InputField({ label, name, type, value, onChange, required }) {
  const effectiveRequired =
    typeof required === "boolean" ? required : isRequired(name);

  return (
    <div>
      <label className="block text-gray-700 font-medium mb-1">
        {label} {effectiveRequired && <span className="text-red-500">*</span>}
      </label>
      <input
        type={type}
        name={name}
